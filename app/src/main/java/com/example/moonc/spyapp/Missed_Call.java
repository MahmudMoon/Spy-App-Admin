...
public class Missed_Call extends Fragment {
    ListView listView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       View view = inflater.inflate(R.layout.dail_layout,container,false);
        ...
        DatabaseReference databaseReference = firebaseDatabase.getReference().child("Pushpo").child("Missed_calls");
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                log_adapter = new log_adapter(arrayList,getContext(),"miss");
