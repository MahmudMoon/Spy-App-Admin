...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    {
        Intent intent = new Intent(LoginActivity.this,Show_child.class);
        startActivity(intent);
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            String Valid_pass =  sharedPreferences.getString("Password","admin@gmail.com");
            ...
            }else
            {
                ...
                builder.setMessage("Unauthorizes access");
